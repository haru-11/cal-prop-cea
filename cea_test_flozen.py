...
str = ispObj.get_full_cea_output( Pc=40.0, MR=7.4, eps=100.0, frozen=1, frozenAtThroat=0, short_output=1, pc_units='bar', output='siunits')
...
pambcf = ispObj.getFrozen_PambCf(Pamb=0.000001, Pc=580.152, MR=7.4, eps=100.0, frozenAtThroat=0)
vac_cstar_tc = ispObj.get_IvacCstrTc(Pc=580.152, MR=7.4, eps=100.0, frozen=1, frozenAtThroat=0) 
...
print("Isp_vac:%f[m/s]",isp_vac*9.80665)